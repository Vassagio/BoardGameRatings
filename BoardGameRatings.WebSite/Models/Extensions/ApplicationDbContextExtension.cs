...
namespace BoardGameRatings.WebSite.Models.Extensions
{
    public static class ApplicationDbContextExtension
    {
        ...
        private static readonly Game SettlersOfCatan = new Game {
            ...
            Description = "Players assume the roles of settlers, each attempting to build and develop holdings while trading and acquiring resources. Players are rewarded points as their settlements grow; the first to reach a set number of points, typically 10, is the winner."
        };
        private static readonly Game LastNightOnEarth = new Game {
            Name = "Last Night On Earth",
            Description = "Players can play on the Hero team or as the Zombies. A modular board randomly determines the layout of the town at the start of each game and there are several different scenarios to play."
        };
