...
namespace BoardGameRatings.WebSite.Models.ModelBuilders
{
    public class PlayerModelBuilder
    {
        ...
        public void Build()
        {
            ...
            _builder.HasIndex(u => new {u.FirstName, u.LastName}).IsUnique();
            _builder.Property(e => e.FirstName).IsRequired().HasMaxLength(20);
            _builder.Property(e => e.LastName).IsRequired().HasMaxLength(30);
        }
    }
}